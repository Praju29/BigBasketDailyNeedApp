...
public class ProductBySubCategoryIdAdapter extends RecyclerView.Adapter<ProductBySubCategoryIdAdapter.MyViewHolder> {

    Context context;
    List<Product> productList;

    public ProductBySubCategoryIdAdapter(Context context, List<Product> productList) {
    ...
    @NonNull
    @Override
    public ProductBySubCategoryIdAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.product_subcategory, null);
        return new ProductBySubCategoryIdAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductBySubCategoryIdAdapter.MyViewHolder holder, int position) {
